    ...
    <div class="main-content">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="#" method="POST" id="add_TU_form" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="my-2">
                                    <label for="name">Nama Jenis Fasilitas</label>
                                    <input type="text" name="namajenisfasilitas" class="form-control"
                                        placeholder="Masukan Nama Jenis Fasilitas" required>
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="my-2">
                                    <label for="name">Nama Jenis Fasilitas</label>
                                    <input type="text" name="namajenisfasilitas" id="namajenisfasilitas"
                                        class="form-control" placeholder="Masukan Nama Jenis Fasilitas" required>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        ...
        <section class="section">
            <div class="section-header">
                <h1>Halaman Data Jenis Fasilitas</h1>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h3 class="text-light">Tabel Jenis Fasilitas</h3>
                                <button class="btn btn-light" data-toggle="modal" data-target="#add_TU_modal"><i
                                        class="bi-plus-circle me-2"></i>Tambah Jenis Fasilitas</button>
                            </div>
                            <div>
    ...
    <script>
        $(function() {
            ...
            $("#add_TU_form").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('jenisfasilitas-store') }}',
                    method: 'post',
                    data: fd,
                    cache: false,
                    contentType: false,
            ...
            $("#edit_TU_form").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('jenisfasilitas-update') }}',
                    method: 'post',
                    data: fd,
                    cache: false,
                    contentType: false,
            ...
            $(document).on('click', '.deleteIcon', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route('jenisfasilitas-delete') }}',
                            method: 'post',
                            data: {
                                id: id,
                                _token: csrf
