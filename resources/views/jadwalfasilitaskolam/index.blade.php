    ...
    <div class="main-content">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="#" method="POST" id="add_TU_form" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="idfasilitasmitra" value="{{ $idfasilitas }}">
                            ...
                            <div class="modal-body">
                                <div class="my-2">
                                    ...
                                    <input type="date" name="tanggalbuka" class="form-control"
                                        placeholder="Masukan Tanggal Buka" required>
                                </div>
                                <div class="my-2">
                                    <label for="name">Jam Buka</label>
                                    <input type="time" name="jambuka" class="form-control" placeholder="Masukan Jam Buka"
                                        required>
                                </div>
                                <div class="my-2">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="my-2">
                                    <label for="name">Tanggal Buka</label>
                                    <input type="date" name="tanggalbuka" id="tanggalbuka" class="form-control"
                                        placeholder="Masukan Tanggal Buka" required>
                                </div>
                                <div class="my-2">
                                    <label for="name">Jam Buka</label>
        ...
        <section class="section">
            <div class="section-header">
                <h1>Halaman Data Jadwal Fasilitas Mitra</h1>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h3 class="text-light">Tabel Jadwal Fasilitas Mitra</h3>
                                <button class="btn btn-light" data-toggle="modal" data-target="#add_TU_modal"><i
                                        class="bi-plus-circle me-2"></i>Tambah Jadwal Fasilitas Mitra</button>
                            </div>
                            <div>
    ...
    <script>
        $(function() {
            ...
            $("#add_TU_form").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('jadwalfasilitaskolam-store') }}',
                    method: 'post',
                    data: fd,
                    cache: false,
                    contentType: false,
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        // console.log(response) var str = response.jam_masuk;
                        var str = response.jambuka;
                        var jambuka = str.substring(0, 5)
                        var str = response.jamtutup;
                        var jamtutup = str.substring(0, 5)
                        $("#tanggalbuka").val(response.tanggalbuka);
                        $("#jambuka").val(jambuka);
                        $("#jamtutup").val(jamtutup);
                        $("#id").val(response.id);
                    }
                });
            });
            ...
            $("#edit_TU_form").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('jadwalfasilitaskolam-update') }}',
                    method: 'post',
                    data: fd,
                    cache: false,
                    contentType: false,
            ...
            $(document).on('click', '.deleteIcon', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route('jadwalfasilitaskolam-delete') }}',
                            method: 'post',
                            data: {
                                id: id,
                                _token: csrf
            ...
            function TU_all() {
                $.ajax({
                    url: '{{ route('jadwalfasilitaskolam-all', $idfasilitas) }}',
                    method: 'get',
                    success: function(response) {
