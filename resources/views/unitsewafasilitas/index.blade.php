    ...
    <div class="main-content">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="#" method="POST" id="add_TU_form" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="my-2">
                                    <label for="name">Nama Unit Sewa Fasilitas</label>
                                    <input type="text" name="namaunit" class="form-control"
                                        placeholder="Masukan Nama Unit Sewa Fasilitas" required>
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="my-2">
                                    <label for="name">Nama Unit Sewa Fasilitas</label>
                                    <input type="text" name="namaunit" id="namaunit" class="form-control"
                                        placeholder="Masukan Nama Unit Sewa Fasilitas" required>
        ...
        <section class="section">
            <div class="section-header">
                <h1>Halaman Data Unit Sewa Fasilitas</h1>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h3 class="text-light">Tabel Unit Sewa Fasilitas</h3>
                                <button class="btn btn-light" data-toggle="modal" data-target="#add_TU_modal"><i
                                        class="bi-plus-circle me-2"></i>Tambah Unit Sewa Fasilitas</button>
                            </div>
                            <div>
    ...
    <script>
        $(function() {
            ...
            $("#add_TU_form").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('unitsewafasilitas-store') }}',
                    method: 'post',
                    data: fd,
                    cache: false,
                    contentType: false,
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                let id = $(this).attr('id');
                $.ajax({
                    url: '{{ route('unitsewafasilitas-edit') }}',
                    method: 'get',
                    data: {
                        id: id,
                        _token: '{{ csrf_token() }}'
            ...
            $("#edit_TU_form").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('unitsewafasilitas-update') }}',
                    method: 'post',
                    data: fd,
                    cache: false,
                    contentType: false,
            ...
            $(document).on('click', '.deleteIcon', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route('unitsewafasilitas-delete') }}',
                            method: 'post',
                            data: {
                                id: id,
                                _token: csrf
            ...
            function TU_all() {
                $.ajax({
                    url: '{{ route('unitsewafasilitas-all') }}',
                    method: 'get',
                    success: function(response) {
