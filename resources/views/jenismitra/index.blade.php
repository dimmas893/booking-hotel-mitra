            ...
            <span aria-hidden="true">&times;</span>
                    ...
                    <form action="#" method="POST" id="add_TU_form" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="my-2">
                                <label for="">Nama Jenis Mitra</label>
                                <input type="text" name="namajenismitra" class="form-control" placeholder="Masukan Nama"
                                    required>
                            </div>

                            <div class="my-2">
                                <label for="">Keterangan</label>
                                <textarea placeholder="Masukan keterangan" name="keterangan" class="form-control">Keterangan</textarea>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="my-2">
                                <label for="">Nama Jenis Mitra</label>
                                <input type="text" name="namajenismitra" id="namajenismitra" class="form-control"
                                    placeholder="Masukan Nama" required>
                            </div>

                            <div class="my-2">
                                <label for="">Keterangan</label>
                                <textarea placeholder="Masukan keterangan" name="keterangan" id="keterangan" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h3 class="text-light">Tabel Jenis Mitra</h3>
                                <button class="btn btn-light" data-toggle="modal" data-target="#add_TU_modal"><i
                                        class="bi-plus-circle me-2"></i>Tambah Jenis Mitra</button>
                            </div>
                            <div>
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#namajenismitra").val(response.namajenismitra);
                        $("#id").val(response.id);
                    }
                });
            });
