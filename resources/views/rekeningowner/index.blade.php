    ...
    <div class="main-content">
        ...
        <section class="section">
            <div class="section-header">
                <h1>Halaman Data No Rekening Owner</h1>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h3 class="text-light">Tabel No Rekening Owner</h3>
                                <button class="btn btn-light" data-toggle="modal" data-target="#add_TU_modal"><i
                                        class="bi-plus-circle me-2"></i>Tambah No Rekening Owner</button>
                            </div>
                            <div>
    ...
    <script>
        $(function() {
            ...
            $("#edit_TU_form").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('rekeningowner-update') }}',
                    method: 'post',
                    data: fd,
                    cache: false,
                    contentType: false,
            ...
            $(document).on('click', '.deleteIcon', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route('rekeningowner-delete') }}',
                            method: 'post',
                            data: {
                                id: id,
                                _token: csrf
